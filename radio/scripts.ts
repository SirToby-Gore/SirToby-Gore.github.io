...
function getData() {
	return {
		branding: {
			...
			tagline:
				'The pulse of Nerve Radio requires architectural integrity.',
			profileImage:
				'nerve-profile-pic.jpeg',
		},
		rationale: [
		...
		tracks: [
			{
				...
				title: 'My Pledge',
				content:
					'As Head of Station Sound, it is my responsibility to ensure that every jingle is mastered to perfection, creating a seamless professional standard for the station.',
			},
			{
				id: 'prog',
				index: '02',
				...
				content:
					'I will supply the Heads of Programming with bespoke soundscapes: morning shows will absolutely pop, evening transitions will be beautifully laid back, and mid-days will be high-energy. The listener experience will be immaculate.',
			},
			{
				id: 'music',
				index: '03',
				...
				content:
					'Jingles and beds must respect the music; they must never fight it. I will work alongside the Head of Music to ensure our audio-beds perfectly complement the A-list and B-list rotations.',
			},
			{
				id: 'brand',
				index: '04',
				title: 'Sync Branding',
				content:
					'Audio and visual logic must align; I will provide pristine audio assets. The Heads of Social Media, Branding, and Events will receive high-energy, broadcast-ready stings so our digital campaigns sound as brilliant as they look.',
			},
			{
				id: 'pods',
				index: '05',
				...
				content:
					'Radio formatting fails in podcasts; they require an entirely different paradigm. I will empower the Head of Podcasts by curating joyous, long-form soundscapes specifically for our creators.',
			},
			{
				id: 'influence',
				index: '06',
			...
			},
			{
				...
				content:
					'I will involve the entire Nerve Radio team to create new iconic jingles, breathing fresh life into our classic sounds while respecting our heritage.',
			},
			{
				id: 'collaborations',
				index: '09',
				...
				content:
					'I will seek out internal collaborations across Nerve, BU, and AUB, as well as reaching out to universities nationwide to bring in diverse tastes and new grooves that keep our sound unique.',
			},
		],
		voting: {
